...
public class frmProveedores extends javax.swing.JInternalFrame {
    ...
    private void btnEjecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEjecutarActionPerformed
        ...
        if(!"".equals(txtBuscador.getText())){
            proveedores.setNombreProveedor(txtBuscador.getText());
            jtProveedores.setModel(proveedores.GetByNameAll());// Se utiliza la instancia a la que se le pasa el texto ingresado
        }else {
