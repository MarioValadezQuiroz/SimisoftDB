...
public class frmNMProductos extends javax.swing.JDialog {
    ...
    public frmNMProductos(){
        ...
        DefaultTableModel resultadoCategoria = categoria.GetAllModel();
        int NumFilasCategoria = resultadoCategoria.getRowCount();
        int tablaIdCategoria[];
        tablaIdCategoria = new int[NumFilasCategoria];
        String tablaNombreCategoria[];
        tablaNombreCategoria = new String[NumFilasCategoria];
        int indexSelectedCategoria = 0;
        for (int i = 0; i < NumFilasCategoria; i++) {
            tablaIdCategoria[i] = (int) resultadoCategoria.getValueAt(i, 0);
            tablaNombreCategoria[i] = (String) resultadoCategoria.getValueAt(i, 1);
            comboBoxIdCategoria.addItem(tablaNombreCategoria[i]);
        }
        this.tablaIdCategoriaClass = new int[NumFilasCategoria];
        this.tablaIdCategoriaClass = tablaIdCategoria;
    }
    ...
    public frmNMProductos(int idProducto) {//boton modificar
        ...
        for (int i = 0; i < NumFilasCategoria; i++) {
            ...
            tablaNombreCategoria[i] = (String) resultadoCategoria.getValueAt(i, 1);
            comboBoxIdCategoria.addItem(tablaNombreCategoria[i]);
            if (tablaIdCategoria[i] == Productos.getIdCategoria()) {
                indexSelectedCategoria = i;
            }
        }
        comboBoxIdCategoria.setSelectedIndex(indexSelectedCategoria);
        this.tablaIdCategoriaClass = new int[NumFilasCategoria];
        this.tablaIdCategoriaClass = tablaIdCategoria;
    }
    /**
    ...
    private void initComponents() {
        ...
        comboBoxIdCategoria = new javax.swing.JComboBox<>();
        ...
        idCategoria.setText("Nombre Categoria");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(comboBoxIdCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        // TODO add your handling code here:
         if (Productos.getIdProducto()> 0) {
            ...
            //Productos.setIdCategoria(Integer.parseInt(txtIdCategoria.getText())); comente para el combo
            //farmacia.setActivo(1);
            int idCategoria = this.tablaIdCategoriaClass[(int) comboBoxIdCategoria.getSelectedIndex()];
    ...
    private javax.swing.JComboBox<String> comboBoxIdCategoria;
